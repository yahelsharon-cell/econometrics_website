...
🚀 Live Demo
🔗 https://econometricswebsite-7zhacagjo3xrojgtweztl2.streamlit.app/
🛠️ Tech Stack & Architecture
Core Logic & Analytics: Python (Pandas, NumPy, SciPy, Statsmodels)

Web Framework: Streamlit (Python-based Web Application Framework)

Frontend Foundations: Tailored UI layouts backed by core web development principles (HTML5, CSS3, JavaScript)
